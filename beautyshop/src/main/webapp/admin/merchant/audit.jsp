...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="btns" style="margin-top: 0px;text-align: center;">
			<a id="auditPhotos" href="javascript: void();" class="submitbtn"><span><em>核查档案信息</em></span></a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a id="auditYesBtn" href="javascript: auditYes();" class="submitbtn"><span><em>审核通过</em></span></a>
			<a id="auditNoBtn" href="javascript: auditNo();" class="submitbtn"><span><em>审核不通过</em></span></a>
