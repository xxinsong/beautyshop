...
<script type="text/javascript" src="js/consulationmanager.js"></script>
</head>
<body>
	<!-- 查询表单 -->
	<div class="searchformDiv" width="90%">
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<th>买家名称:</th>
				<td>
					<input type="text" name="searchMerchantName" id="searchMerchantName" class="searchipt" />
				</td>
	...
	<div class="formgrid" style="margin-bottom: 10px; margin-top: 10px;">
		...
		<div class="grid" id="consulList">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<!-- <th field="goodsId">商品id</th> -->
					<th field="goodName">商品名称</th>
					<th field="merchantName">买家名称</th>
					<th field="commitTime">咨询时间</th>
					<th field="content">咨询内容</th>
					<th field="replyTime">回复时间</th>
				</tr>
			</table>
		</div>
	</div>
	<div id="consulEditorForm" class="formgrid">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
						...
						<tr>
							...
							<td>
							    <textarea  id="replyContent"   nullable="false" name="replyContent" style="width: 900px;" ></textarea>
							</td>
						</tr>
					</table>
