				...
				<div id="goodsEditorForm" class="formgrid">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
                            ...
                            <input type="hidden" id="catalogName" name="catalogName" class="ipttxt" />
						...
						<tr>
							...
							<th><label class="ltxtc">*</label>售价：</th>
							<td>
								<input type="text" id="price" name="price" max_length="8" class="ipttxt" nullable="false" valid_type="double" />
							</td>
                            <th><label class="ltxtc">*</label>原价：</th>
                            <td>
                                <input type="text" id="oriPrice" name="oriPrice" max_length="8" class="ipttxt" nullable="false" valid_type="double" />
                            </td>
						...
						<tr>
							...
							<td colspan="5">
							    <textarea cols="120" rows="3" id="goodsDesc" name="goodsDesc" ></textarea>
							</td>
                        ...
                        <tr>
                            <th>提示语：</th>
                            <td colspan="5">
                                <textarea cols="120" rows="3" id="hints" name="hints" ></textarea>
                            </td>
                        </tr>
					</table>
