...
<body>
	<div>
		<div style="float: left; width: 20%; border-top:1px solid #d5d5d5;margin-top:5px;">
		...
		<div style="width:1px; background:#d5d5d5; position: absolute;top:5px;left:20%;bottom:0;"></div>
		<!-- 查询表单 -->
		<div style="float: right; width:79%;margin-top:5px;">
			...
			<div class="formgrid" style="margin-bottom: 10px; margin-top: 10px;margin-left:0;">
				<div class="formgrid_title">
					<h2>员工列表</h2>
				</div>
				<!-- 列表 -->
			...
			<div>
				...
				<div id="privilegeTab" style="margin-top: 10px;">
					<div id="privilegeContain" class="formgrid" style="height: 130px;">
						<table id="treegrid">
							<thead>
								<tr>
