            ...
            <div class="pers_cen_div mt">
                ...
                <div class="pers_cen_con">
                    <div class="announce_content">
  						<li align="center"><img src="<%=path%>/market/main/images/problem1.jpg"/></li>
  						<li align="center"><img src="<%=path%>/market/main/images/problem2.jpg"/></li>
  						<li align="center"><img src="<%=path%>/market/main/images/problem3.jpg"/></li>
  						<li align="center"><img src="<%=path%>/market/main/images/problem4.jpg"/></li>
