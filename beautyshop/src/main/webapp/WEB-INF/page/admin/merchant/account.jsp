...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="btns" style="margin-top: 10px;text-align: center;">
			<a id="lock" href="javascript: lock();" class="ui_blue_btn"><span><em>锁定</em></span></a>
			<a id="unlock" href="javascript: unlock();" class="ui_blue_btn"><span><em>解锁</em></span></a>
			<a id="cancel" href="javascript: cancel();" class="ui_blue_btn"><span><em>注销</em></span></a>		
		</div>
