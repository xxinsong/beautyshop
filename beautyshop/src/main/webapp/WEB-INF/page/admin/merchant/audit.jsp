...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="btns" style="margin-top: 10px;text-align: center;">
			<a id="auditPhotos" href="javascript: void();" class="ui_blue_btn"><span><em>核查档案信息</em></span></a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a id="auditYesBtn" href="javascript: auditYes();" class="ui_blue_btn"><span><em>审核通过</em></span></a>
			<a id="auditNoBtn" href="javascript: auditNo();" class="ui_blue_btn"><span><em>审核不通过</em></span></a>
        ...
        <!-- 弹出层 -->
		<div id="popDiv" class="ui_dialog" style="display: none;height:700px;width: 1100px;padding-left:10px;">
			<div class="ui_dialog_fore">
				<div class="ui_dialog_title">
					<div class="buttons">
						<a id="closePop" class="close_btn"></a>
					</div>
					<span>核查档案信息</span>
				</div>
				<div class="ui_dialog_body" >
					<div class="ui_dialog_content" >
						<div  style="text-align: center;height:530px;">
							<iframe id="photosIframe" frameborder="0" width="100%" height="100%" src=""></iframe>
						</div>
					</div>
				</div>
			</div>
